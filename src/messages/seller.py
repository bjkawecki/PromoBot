HELP_TOPICS_INFO = (
    ...
    "Mit <i>PromoBot</i> kannst du ganz einfach Produkte bewerben, direkt über Telegram.\n"
    "Erstelle dein Verkäuferprofil, verknüpfe dein Stripe-Konto, erstelle Promos und teile sie in deinem Kanal.\n"
    "Keine Website nötig, alles läuft im Chat.\n\n"
    "❓ <b>Wie erstellt man Promos?</b>\n\n"
    "Um Promos zu erstellen, starte den Vorgang 'Promo erstellen'.\n"
    "Eine neue erstellte Promo wird <b>nicht</b> automatisch aktiviert oder geteilt.\n"
    "Eine Promo muss explizit gepostet werden.\n"
    "Um eine Promo zu posten, muss eine Stripe-ID angegeben worden sein.\n"
    "Eine gepostete Promo erscheint in deinem Kanal als Nachricht, die von Abonnenten angeklickt werden kann.\n"
    "Wer die Nachricht klickt, wird zum <i>PromoBot</i> geleitet und durchläuft den Bestelleprozess.\n\n"
